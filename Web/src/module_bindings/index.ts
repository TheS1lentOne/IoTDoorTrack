...
import AddDeviceLogReducer from "./add_device_log_reducer";

// Import all procedure arg schemas

// Import all table schema definitions
import DeviceLogRow from "./device_log_table";
...
const tablesSchema = __schema({
  DeviceLog: __table({
    name: 'device_logs',
    indexes: [
  { name: 'Id', algorithm: 'btree', accessor: 'id', columns: [
    'id',
  ] },
],
    constraints: [
      { name: 'device_logs_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, DeviceLogRow),
});
...
const reducersSchema = __reducers(
  __reducerSchema("add_device_log", AddDeviceLogReducer),
);
